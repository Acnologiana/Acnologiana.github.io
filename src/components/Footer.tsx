...
export default function Footer() {
  ...
  return (
    <footer className="w-full px-6 py-12 border-t border-indigo-500/20 bg-gradient-to-t from-indigo-500/5">
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <div className="flex gap-6">
          {socialLinks.map((link, idx) => (
            <motion.a
              key={idx}
              href={link.href}
              className="text-gray-400 hover:text-indigo-400 text-2xl transition-colors"
        ...
        {/* Tagline */}
        <div className="text-gray-400 text-sm text-center md:text-right italic">
